...
public class User implements Serializable {
	...
	public void registerUser(String email, String password, String nickName) {
		this.email = email;
		this.salt = PasswordEncryptor.generateSalt(); // 솔트 생성
		this.password = PasswordEncryptor.encrypt(password, salt); // 비밀번호 암호화
	...
	public void updateUserInfo(String email, String password, String nickName) {
		...
		if (password != null && !password.isEmpty()) {
			this.password = PasswordEncryptor.encrypt(password, this.salt);
		}
	...
	public boolean deleteUser(String password) {
		// 비밀번호 확인
		if (this.password.equals(PasswordEncryptor.encrypt(password, this.salt))) {
	...
	public boolean loginUser(String email, String password) {
		// 이메일과 비밀번호 확인
		return this.email.equals(email) && this.password.equals(PasswordEncryptor.encrypt(password, this.salt));
	}
